...
class Visualizer():
    ...
    def display_current_results(self, visuals, epoch, prefix=None):
    ...
    table td {width: %dpx; height: %dpx; padding: 4px; outline: 4px solid black}
        ...
        if self.use_html: # save images to a html file
            ...
            for n in range(epoch, 0, -1):
                ...
                webpage.add_images(ims, txts, links, width=self.win_size, prefix=prefix)
            webpage.save()
    ...
    def save_images(self, webpage, visuals, image_path, prefix=None):
